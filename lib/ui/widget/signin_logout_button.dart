...
Widget signin_logout_button(BuildContext context, {required String btnName, required String routePath}) {
  return InkWell(
    ...
    child: Container(
      height: 30,
      width: 250,
      decoration: BoxDecoration(borderRadius: BorderRadius.circular(5), color: context.primary),
      child: Center(
        child: Text(btnName, style: context.displaySmall?.copyWith(color: context.onPrimary, fontSize: pixel18)),
      ),
    ),
  );
}
