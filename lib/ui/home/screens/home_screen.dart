    ...
    return Scaffold(
        ...
        body: Column(
          ...
          children: [
            ...
            BinsarFilledButton(width: 300, name: "LOG OUT", onTap: () {})
        ...
        bottomNavigationBar: BottomNavigationBar(
          ...
          items: [
            ...
            BottomNavigationBarItem(
                ...
                label: 'Vacations'),
            BottomNavigationBarItem(
                icon: Image.asset(ImageAssets.menuIcon, height: BottomNavigtionbariconSize, width: BottomNavigtionbariconSize), label: 'Menu'),
          ],
        ));
  }
}
