        ...
        children: [
          Expanded(
            ...
            children: [
              ...
              height10,
              Container(
                margin: const EdgeInsets.symmetric(horizontal: pixel20, vertical: pixel2),
                height: pixel70,
                child: Row(
              ...
              ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return deliveryDetailListItem(context,
                        title: 'FRESH FRAM MILK', imageName: ImageAssets.farmmilkbottle, packing: '1 Litre', quantity: 500);
                  },
                  itemCount: 3),
              height10,
              Container(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(pixel5), border: Border.all(color: AppColors.lightTextColor, width: 0.5)),
                        child: Row(
                          crossAxisAlignment: CrossAxisAlignment.center,
                          children: [
                            width8,
            ...
            child: Row(
              children: [
                Expanded(
                  ...
                  onTap: () {},
                  child: Container(
                    padding: const EdgeInsets.all(pixel7),
                    decoration: BoxDecoration(
