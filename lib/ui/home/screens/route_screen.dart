          ...
          children: [
            ...
            Container(
              ...
              child: Row(
                children: [
                  Expanded(
                      child: BinsarFilledButton(name: 'START TRIP', onTap: (){},backgroundcolor: AppColors.statusGreen,padding: EdgeInsets.symmetric(vertical: 5),)
                  ),
                  width10,
                  Expanded(
                      child: BinsarFilledButton(name: 'END TRIP', onTap: (){},backgroundcolor: AppColors.statusOrange,padding: EdgeInsets.symmetric(vertical: 5))
                  ),
                ],
              ),
            ),
            ...
            height20,
            BinsarFilledButton(name: 'OPEN IN GOOGLE MAPS', onTap: (){},backgroundcolor: context.primary,padding: EdgeInsets.symmetric(vertical: 5),width: 250,),
            height16,
            Expanded(
                child: ListView(
                  children: [
